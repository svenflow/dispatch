...
for size in 200 150 100 75 50 30 20 10 5; do
    ...
    $CHROME navigate "$TAB_ID" "file:///Users/jsmith/code/click-test/index.html?diameter=${size}&rounds=10&bg=white&color=black" >/dev/null 2>&1
    sleep 2

    echo "--- Testing ${size}px diameter ---"
    cd /Users/jsmith/code/click-test
