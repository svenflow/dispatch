...
def sanitize_chat_id(chat_id: str) -> str:
    ...
    Examples:
        +15555550001 -> _15555550001
        signal:+15555550001 -> _15555550001
...
def get_session_name(chat_id: str, source: str = "imessage") -> str:
    ...
    Args:
        chat_id: Phone number or group ID (e.g., "+15555550001")
        source: "imessage" or "signal"

    Returns:
        Session name like "imessage/_15555550001" or "signal/_15555550001"
    """
