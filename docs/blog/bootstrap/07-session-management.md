...
- `08-browser-automation.md` - Chrome control extension
- `09-smart-home.md` - Hue, Lutron, Sonos integrations
- `10-signal-integration.md` - Adding Signal as second channel
